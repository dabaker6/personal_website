...
- [X] T008 [US1] Expose serialized graph data for the page in `templates/match_detail.html`
- [X] T009 [US1] Render innings progression lines, axes, and over-grouped points in `static/js/match_detail.js`
- [X] T010 [P] [US1] Add graph layout, legend, and responsive chart styling in `static/css/site.css`
...
- [X] T013 [US2] Render wicket markers and support multiple wickets in the same over in `static/js/match_detail.js`
- [X] T014 [P] [US2] Add tooltip and wicket-marker styling in `static/css/site.css`
...
- [X] T016 [US3] Render non-qualifying, partial, and unavailable graph messaging in `templates/match_detail.html`
- [X] T017 [US3] Update client-side graph initialization to safely skip non-qualifying and unavailable states in `static/js/match_detail.js`
- [X] T018 [P] [US3] Refine responsive spacing and fallback presentation for scorecard-plus-graph layouts in `static/css/site.css`
